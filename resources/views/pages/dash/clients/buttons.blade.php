...
<div class="text-right">
    ...
    @if($jackson->file_akta_notaris=='akta_notaris/' && strtolower($jackson->jenis)=='swasta')
    ...
    @endif
    @if($jackson->file_ijin_usaha=='ijin_usaha/' && strtolower($jackson->jenis)=='swasta')
    ...
    <a href="#" onclick="window.dashboardClient.tj('{{$json}}')" title='Kelola Penanggung Jawab' class="btn btn-sm btn-success">
